import math
from Solucion_2.Algorithms_Sol1 import Algorithms, Methods
...
class ConcertZoo2:
    ...
    def scene_grandness_key(scene, animals):
        ...
        """
        return Methods.sum(ConcertZoo2.scene_grandness_by_animal(animal, animals) for animal in scene)
    ...
    def max_animal_grandness_key(scene, animals):
        ...
        """
        return Methods.max([animal_grandness for animal, animal_grandness in animals if animal in scene])
    ...
    def scene_grandness_by_animal(animal, animals):
        ...
        for animal_tuple in animals:
            if animal_tuple[0] == animal:
                return animal_tuple[1]
    
        # Manejar el caso en el que el animal no se encuentra en la lista
        raise ValueError(f"El animal '{animal}' no se encuentra en la lista de animales")
    ...
    def part_grandness_key(part, animals):
        ...
        """
        return Methods.sum(ConcertZoo2.scene_grandness_key(scene, animals) for scene in part)
    ...
    def sort_aperture(self):
        ...
        for scene in self.aperture:
            Algorithms.merge_sort(scene, 0, len(scene) - 1, self.animals, ConcertZoo2.scene_grandness_by_animal)

        # Ordenar cada escena por grandeza total.
        Algorithms.merge_sort(self.aperture, 0, len(self.aperture) - 1, self.animals, key_func=ConcertZoo2.scene_grandness_key)

        # Ordenar las escenas por máxima grandeza individual en caso de empate.
        Algorithms.merge_sort(self.aperture, 0, len(self.aperture) - 1, self.animals, key_func=ConcertZoo2.max_animal_grandness_key)
    ...
    def sort_rest_of_show(self):
        ...
        for part in self.rest_of_show:
            ...
            # Ordenar cada escena por grandeza total.
            Algorithms.merge_sort(part, 0, len(part) - 1, self.animals, key_func=ConcertZoo2.scene_grandness_key)

            # Ordenar las escenas por máxima grandeza individual en caso de empate.
            Algorithms.merge_sort(part, 0, len(part) - 1, self.animals, key_func=ConcertZoo2.max_animal_grandness_key)

        # Ordenar cada parte por su grandeza total de parte que es la suma de las grandezas totales de la escena.
        Algorithms.merge_sort(self.rest_of_show, 0, len(self.rest_of_show) - 1, self.animals, key_func=ConcertZoo2.part_grandness_key)
    ...
    def max_grandeur_scene(self):
        ...
        for scene in self.aperture:
            grandeur_sum = ConcertZoo2.scene_grandness_key(scene, self.animals)
    ...
    def average_grandeur(self):
        ...
        for scene in self.aperture:
            total_grandeur += 2 * ConcertZoo2.scene_grandness_key(scene, self.animals)
